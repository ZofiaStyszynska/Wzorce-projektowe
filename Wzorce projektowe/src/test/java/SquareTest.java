...
class SquareTest {
    ...
    void shouldCalculatePerimeter() {
        assertEquals(EXPECTED_PERIMETER, testSquare.countPerimeter());
    }

    @Test
    void shouldCalculateArea() {
        assertEquals(EXPECTED_AREA, testSquare.countArea());
    }
    ...
    void shouldSetColourByBuilder() {
        assertEquals(TEST_COLOUR, testSquare.addColour(Colourable.Colour.BLUE));
    }
}